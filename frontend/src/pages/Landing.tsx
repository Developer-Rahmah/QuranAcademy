...
export function Landing() {
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
      ...
      {/* Main content — wrapped in a single <main> landmark so
          screen-readers and crawlers can identify the primary content
          region. Hero (H1) + features section (H2) live here. */}
      <main className="flex-1 flex flex-col">
        ...
        <section
          ...
          className="px-4 sm:px-8 py-12 bg-secondary/40"
        >
          <h2
            id="features-heading"
